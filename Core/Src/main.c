...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	OLED_Display_On();
	OLED_Clear();
	OLED_ShowString(Center("OLED"), 0, 1, "OLED");
	OLED_ShowString(0, 2, 0, "1.3' OLED TEST");
	OLED_ShowString(0, 4, 1, "0123456789ABCDEF0123456789ABCDEF");
	//OLED_ShowString(0, 6, 0, "1.3' OLED TEST");
  /* USER CODE END 2 */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DC_Pin|RES_Pin|D1_Pin|D0_Pin, GPIO_PIN_RESET);
